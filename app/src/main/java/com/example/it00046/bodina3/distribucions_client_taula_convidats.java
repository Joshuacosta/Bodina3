...
public class distribucions_client_taula_convidats extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        g_Draw.papa = this;
        // Menu lateral dret: carreguem la llista de convidats de la celebracio
        l_DRL_Convidats = (DrawerLayout) findViewById(R.id.DistribucionsClientTaulaConvidatsNDRConvidats);
        g_LVW_Convidats = (ListView) findViewById(R.id.DistribucionsClientMantTaulaConvidatsNDLConvidats);
        DAOConvidats.Llegir(Globals.g_CelebracioClientTreball.Codi, g_LVW_Convidats, R.layout.linia_lvw_llista_taulacomensals_convidats_seleccio, this);
        // Listener damunt la llista de convidats i obrim
